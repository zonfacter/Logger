...
class StdoutRedirector:
    ...
    def __init__(self, logger: logging.Logger, level: int = logging.INFO):
        ...
        self._original_stderr = sys.__stderr__  # Keep reference to original stderr
    
    def write(self, msg: str) -> None:
        # Prevent recursion: if we're already in write(), just use original stderr
        if self._in_write:
        ...
        if msg and msg.strip():
            ...
            try:
                ...
                if self._original_stderr:
                    try:
                        self._original_stderr.write(f"[LOG ERROR] {msg}")
                    except Exception:
                        pass
            finally:
