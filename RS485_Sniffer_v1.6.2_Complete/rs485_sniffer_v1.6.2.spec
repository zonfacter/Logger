...
"""
RS485 Sniffer v1.6.2 - PyInstaller Spec File
=============================================

Build Instructions:
1. Install PyInstaller: pip install pyinstaller
2. Place this file in the same folder as rs485_sniffer_v1.6.2.py
3. Run: pyinstaller rs485_sniffer_v1.6.2.spec
